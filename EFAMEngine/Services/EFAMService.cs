 ...
 *                              - GetSharedDrives()
 *                              
 * 2019-09-26   DJJUNG          사용자 드라이브 목록 가져오는 부분 수정 (S-Work과 조선사업부 전처리기 지시문 구분)
 *                              - GetSharedDrives()
 * ====================================================================================================================
 */
#endregion
...
namespace Link.EFAM.Engine.Services
{
    ...
    public class EFAMService
    {
        ...
        public List<SharedDrive> GetSharedDrives()
        {
            ...
            driveInfos = m_webService.GetUserDriveListByUserID_Swork_Letter(m_credential.UserId);
            ...
            foreach (UserDrive driveInfo in driveInfos)
            {
                ...
                {
#if (INTEROP_SWORK || INTEROP_SWORK_HHISB)  // ====================================================
                    if (String.IsNullOrEmpty(driveInfo.ConnectDriveName))
                    {
                        sharedDrive.DriveName = "*";
                    }
                    else
                    {
                        sharedDrive.DriveName = driveInfo.ConnectDriveName + ":";
                        sharedDrive.IsFixedDriveName = true;
                    }
#else   // ========================================================================================
                    sharedDrive.DriveName = "*";
                    sharedDrive.IsFixedDriveName = false;
#endif  // INTEROP_SWORK || INTEROP_SWORK_HHISB ===================================================
