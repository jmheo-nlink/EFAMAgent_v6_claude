#region 변경 이력
/*
 * Author : Link mskoo (2011. 9. 1)
 * 
 * ====================================================================================================================
 * Date         Name            Description of Change
 * --------------------------------------------------------------------------------------------------------------------
 * 2011-09-01   mskoo           최초 작성.
 * 
...
{
    /// <summary>
    /// 액세스 제어와 관련된 작업에 대한 런타임 동작을 확장하는데 사용할 수 있는 메소드를 구현한다.
    /// </summary>
    public interface IAccessControlBehavior
    {
        #region 메소드
        ...
        void OnActivate(List<string> shareNames);
        ...
        void OnGetPermissions(FileAccessRights fileRights, ProcessInfo processInfo, string path, bool isDir);
        ...
        /// </remarks>
        bool OnWriteLog(ProcessInfo processInfo, string path, string newPath, FileAction action);
