...
namespace Link.EFAM.Core
{
    ...
    public class SharedDrive : NetworkDrive
    {
        ...
        /// <summary>
        /// 공유 드라이브에 사용할 드라이브 이름이 고정되어 있는지 여부를 나타내는 값을 가져오거나 설정한다.
        /// </summary>
        /// <value>
        /// 공유 드라이브에 사용할 드라이브 이름이 고정되어 있으면 <b>true</b>, 그렇지 않으면 <b>false</b>
        /// </value>
        public bool IsFixedDriveName
        {
